...
export const receiveTransferApi = (id: string, receivedBy: string, items: { productId: string; quantity: number }[]) => mutation(`/transfers/${encodeURIComponent(id)}/receive/`, "POST", { receivedBy, items });
